<template>
  <div class="tweet-actions">
    ...
    <span class="actions" >
      <svg class="default" v-if="!tweet['favorited']" v-on:click="FAVORITE({account: accounts[route.params.id_str], idStr: tweet['id_str'], index: index}) + favorite()" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 75 72">
    ...
    <span class="actions" >
      <svg class="default" v-if="!tweet['retweeted']" v-on:click="RETWEET({account: accounts[route.params.id_str], idStr: tweet['id_str'], index: index}) + retweet()" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 75 72">
